...
namespace Peanuts
{
    ...
    public sealed class TagSet : IComparable<TagSet>, ICloneable
    {
        ...
        internal TagSet(IEnumerable<Type> compTypes) : this()
        {
            foreach (var id in compTypes.Select(Peanuts.GetId))
                Set(id);
        }
        ...
        public TagSet(params Type[] compTypes) : this((IEnumerable<Type>)compTypes)
        {
        }
